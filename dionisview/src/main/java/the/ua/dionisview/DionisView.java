...
public final class DionisView {
     ...
     * AgentWeb 's TAG
     */
    private static final String TAG = DionisView.class.getSimpleName();
    /**
     * Activity
     */
     ...
     * AgentWeb
     */
    private DionisView mDionisView = null;
    /**
     ...
     * WebChromeClient
     */
    private the.ua.dionisview.WebChromeClient mWebChromeClient;
    /**
     * WebViewClient
     */
    private the.ua.dionisview.WebViewClient mWebViewClient;
    /**
     * is show indicator
     */
    ...
    public DionisView clearWebCache() {
    ...
    public static class PreAgentWeb {
        ...
        PreAgentWeb(DionisView dionisView) {
        ...
        public DionisView get() {
            ready();
            return mDionisView;
        }

        public DionisView go(@Nullable String url) {
            if (!isReady) {
                ready();
            }
    ...
    private DionisView go(String url) {
    ...
    public static final class AgentBuilder {
        ...
        public AgentBuilder(@NonNull Activity activity, @NonNull Fragment fragment) {
            mActivity = activity;
            mFragment = fragment;
            mTag = DionisView.FRAGMENT_TAG;
        }

        public AgentBuilder(@NonNull Activity activity) {
            mActivity = activity;
            mTag = DionisView.ACTIVITY_TAG;
        }
        ...
        private PreAgentWeb buildAgentWeb() {
            if (mTag == DionisView.FRAGMENT_TAG && this.mViewGroup == null) {
                throw new NullPointerException("ViewGroup is null,Please check your parameters .");
            }
            return new PreAgentWeb(HookManager.hookAgentWeb(new DionisView(this), this));
        }
    ...
    public static class CommonBuilder {
        ...
        public CommonBuilder setWebChromeClient(@Nullable the.ua.dionisview.WebChromeClient webChromeClient) {
            this.mAgentBuilder.mWebChromeClient = webChromeClient;
            return this;
        }

        public CommonBuilder setWebViewClient(@Nullable the.ua.dionisview.WebViewClient webChromeClient) {
...
//        public CommonBuilder setWebViewClient(the.ua.dionisview.WebViewClient webViewClient) {
